...
final class Preset
{
    ...
    public function customFieldsSchema(): array
    {
        return $this->customFieldsSchema;
    }
    ...
    public function quoteTemplate(): array
    {
        return $this->quoteTemplate;
    }

    public function aiHints(): array
    {
        return $this->aiHints;
    }

    public function pdfTemplateKey(): string
    {
        return $this->pdfTemplateKey;
    }
